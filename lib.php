 ...
 * @return string
 */
function theme_ten_get_main_scss_content($theme) {
    global $CFG;
 ...
 * @return bool
 */
// function theme_ten_pluginfile($course, $cm, $context, $filearea, $args, $forcedownload, array $options = array()) {
//     if ($context->contextlevel == CONTEXT_SYSTEM) {
//         $theme = theme_config::load('ten');
